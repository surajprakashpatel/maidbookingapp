...
import { fetchCustomerById, updateCustomerStatus } from '@/lib/services/userService';
import { Customer } from '@/lib/types';
import { useApp } from '@/lib/app-context';
import {
  ArrowLeft, MapPin,
  ShieldAlert, CheckCircle, XCircle, Loader, BookOpen
} from 'lucide-react';
...
export default function AdminUserDetailPage({ params }: PageProps) {
  ...
  useEffect(() => {
    async function load() {
      setLoading(true);
      const data = await fetchCustomerById(resolvedParams.id);
      setCustomer(data);
      setLoading(false);
    }
    load();
